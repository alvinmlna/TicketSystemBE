...
namespace API.Helpers
{
	public class ApiResponseHelpers
	{
		...
		{
			return new BadRequestObjectResult(new ApiResponse(System.Net.HttpStatusCode.BadRequest, errorMessage: message, data: data));
		}

		public static NotFoundObjectResult NotFound(object data, string message = "Object not found!")
		{
			return new NotFoundObjectResult(new ApiResponse(System.Net.HttpStatusCode.NotFound, errorMessage: message, data: data));
		}
	}
}
