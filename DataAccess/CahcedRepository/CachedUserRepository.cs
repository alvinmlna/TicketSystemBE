...
{
    public class CachedUserRepository : GenericRepository<User>, IUserRepository
    {
        private readonly UserRepository _userRepository;
        private readonly IMemoryCache _memoryCache;
        TimeSpan expiredCacheTime = TimeSpan.FromMinutes(2);

        public CachedUserRepository(TicketDBContext ticketContext, UserRepository userRepository, IMemoryCache memoryCache) : base(ticketContext)
        {
